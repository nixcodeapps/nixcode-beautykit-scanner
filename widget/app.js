...
(function (angular, buildfire) {
    angular.module('BarcodeScanner', ['ui.router','ngAnimate','ngMaterial', 'socialModals', 'BarcodeScannerPluginFilters','ui.bootstrap'])
        .config(['$sceDelegateProvider','$stateProvider', '$urlRouterProvider', '$compileProvider', '$httpProvider', function ($sceDelegateProvider,$stateProvider, $urlRouterProvider, $compileProvider, $httpProvider) {
            ...
            //         controller: 'WidgetScannerCtrl'
            //     })
            //     .when('/saved', {
            //         templateUrl: 'templates/saved.html',
            //         controller: 'WidgetSavedCtrl'
            //     })
            //     .when('/history', {
            //         templateUrl: 'templates/history.html',
            //         controller: 'WidgetHistoryCtrl'
            //     })
            //     .otherwise({ redirectTo: '/scanner' });
